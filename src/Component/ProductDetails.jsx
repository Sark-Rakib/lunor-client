      ...
      <div className="w-11/12 mx-auto py-10">
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            <h1 className="font-semibold bg-gray-400 rounded-full w-max px-3">
              {tuition.ability}
            </h1>
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full md:w-1/2 py-4 px-6 bg-gray-400 text-white text-lg font-bold rounded-xl shadow-lg hover:bg-gray-500 hover:shadow-2xl transition-all"
              >
                Order Now
              </button>
            </div>
