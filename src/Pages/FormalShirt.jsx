...
const FormalShirt = () => {
  ...
  useEffect(() => {
    const fetchSweetProducts = async () => {
      try {
        const res = await axiosSecure.get("/products?category=formal shirt");
      ...
      <div className="w-11/12 mx-auto px-2 md:px-6">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-black">
            All <span className="text-gray-400">Formal Shirts</span>
          </h2>
          <p className="text-gray-600 mt-1">Formal Shirt Collection</p>
        </div>
