...
const Chino = () => {
  ...
  useEffect(() => {
    const fetchSweetProducts = async () => {
      try {
        const res = await axiosSecure.get("/products?category=chino");
  ...
  return (
    <section className="py-10">
      <title>Lunor | Chino</title>
      <div className="px-4 sm:px-7 md:px-6">
        {/* Title */}
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-black">
            All <span className="text-gray-400">Chino Pant</span>
          </h2>
          <p className="text-gray-600 mt-1">Chino Pant Collection</p>
        </div>
