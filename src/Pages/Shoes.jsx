...
const Shoes = () => {
  ...
  useEffect(() => {
    const fetchSweetProducts = async () => {
      try {
        const res = await axiosSecure.get("/products?category=shoes");
  ...
  return (
    <section className="py-10 ">
      <title>Lunor | Shoes</title>
      <div className="px-4 sm:px-7 md:px-6">
        {/* Title */}
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-black">
            All <span className="text-gray-400">Shoes</span>
          </h2>
          <p className="text-gray-600 mt-2">Shoe Collection</p>
        </div>
